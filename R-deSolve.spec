...
Version  : 1.40
Release  : 68
URL      : https://cran.r-project.org/src/contrib/deSolve_1.40.tar.gz
Source0  : https://cran.r-project.org/src/contrib/deSolve_1.40.tar.gz
...
%setup -q -n deSolve
pushd ..
cp -a deSolve buildavx2
popd
pushd ..
cp -a deSolve buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737139229
...
/usr/lib64/R/library/deSolve/NEWS.md
...
/usr/lib64/R/library/deSolve/doc/dynload-fastlsoda/check_fastlsoda.R
/usr/lib64/R/library/deSolve/doc/dynload-fastlsoda/lorenzc.c
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/deSolve/libs/deSolve.so
/V4/usr/lib64/R/library/deSolve/libs/deSolve.so
